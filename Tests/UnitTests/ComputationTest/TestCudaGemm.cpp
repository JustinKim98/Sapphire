...
//
//     auto* A = Util::TensorDescriptor::CreateTensorData(shapeA, CudaDevice,
//         Type::Dense, batchSize);
//
//     auto* B = Util::TensorDescriptor::CreateTensorData(shapeB, CudaDevice,
//         Type::Dense, batchSize);
//
//     auto* C = Util::TensorDescriptor::CreateTensorData(shapeC, CudaDevice,
//         Type::Dense, batchSize);
//
//     auto* Out = Util::TensorDescriptor::CreateTensorData(shapeOut, CudaDevice,
//         Type::Dense, batchSize);
//
...
//
//     Naive::Gemm(Out->DenseMatHost, A->DenseMatHost, B->DenseMatHost,
...
//
//     const auto batchSize = 2;
//     auto* cudaA = Util::TensorDescriptor::CreateTensorData(shapeA, CudaDevice,
//         Type::Dense, batchSize);
//
//     auto* cudaB = Util::TensorDescriptor::CreateTensorData(shapeB, CudaDevice,
//         Type::Dense, batchSize);
//
//     auto* cudaC = Util::TensorDescriptor::CreateTensorData(shapeC, CudaDevice,
//         Type::Dense, batchSize);
//
//     auto* cudaOut = Util::TensorDescriptor::CreateTensorData(
//         shapeOut, CudaDevice, Type::Dense, batchSize);
//
//     auto* A = Util::TensorDescriptor::CreateTensorData(shapeA, CudaDevice,
//         Type::Dense, batchSize);
...
//         Type::Dense, batchSize);
//
//     Util::TensorDescriptor::CopyHostToGpu(cudaA);
//     Util::TensorDescriptor::CopyHostToGpu(cudaB);
//     Util::TensorDescriptor::CopyHostToGpu(cudaC);
//
...
//         cudaA->PaddedColumnSize, batchSize, false, false, false);
//
//     Util::TensorDescriptor::CopyGpuToHost(cudaOut);
//
//     Naive::Gemm(Out->DenseMatHost, A->DenseMatHost, B->DenseMatHost,
//                        C->DenseMatHost, Out->PaddedRowSize,
