...
void Conv2DBackProp::m_runBackProp()
{
    ...
    if (m_hasBias)
    {
        ...
        TensorData mean0(mean0Shape, dy.GetType(), dy.GetDeviceInfo());
        TensorData mean1(mean1Shape, dy.GetType(), dy.GetDeviceInfo());
        TensorData mean2(mean2Shape, dy.GetType(), dy.GetDeviceInfo());
